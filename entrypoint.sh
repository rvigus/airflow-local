...
case "$1" in
  webserver)
    ...
    airflow db init
    airflow users create --username airflow --password airflow --firstname Rory --lastname Vigus --role Admin --email rory.vigus@blabla.org
    ## HERE IS WHERE VARIABLES ARE CREATED.
